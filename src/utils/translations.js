export const translations = {
  ...
  ar: {
    ...
    title: "عزيزي العميل،",
    description: "يرجى الضغط على زر \"استعلام\" ادناه لعرض جميع أرقام MSISDN المرتبطة برقم هويتك الوطنية.\n\nيرجى ملاحظة أن هذه القائمة مرتبطة برقمك الوطني، لذا يرجى عدم مشاركة هذه الصفحة أو الرابط مع أي شخص",
